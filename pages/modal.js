...
const MODAL_URLS = {
  'souris': 'seance1_enfants.html',
  'clavier': 'seance2_enfants.html', 
  'paint': 'seance3_enfants.html',
  'word': 'seance1_collegues.html',
  'outlook': 'seance2_collegues.html',
  'excel': 'seance3_collegues.html'
};
    ...
    <div class="modal-overlay">
      <div class="modal-content">
        <div class="modal-header">
          <button class="modal-fiche-btn" onclick="goToFiches()">📋 Fiches</button>
